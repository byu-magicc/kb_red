                                 ...
                                 sdf::ElementPtr _sdf)
{
  ...
  // {
    ...
    this->encoder_pub = this->rosNode->advertise<kb_utils::Encoder>(
      this->model->GetName() + "/encoder", 10);
    this->state_pub = this->rosNode->advertise<kb_autopilot::State>(
      this->model->GetName() + "/truth", 10);
